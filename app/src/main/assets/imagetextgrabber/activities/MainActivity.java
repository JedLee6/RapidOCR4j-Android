...
package example.imagetextgrabber.activities;
...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try
        {
            ...
            saveNoteTV.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            if (loadDefaultImage) {
                com.bumptech.glide.Glide.with(MainActivity.this)
                        ...
                        .listener(new RequestListener<Drawable>() {
                            @Override
                            public boolean onLoadFailed(@androidx.annotation.Nullable GlideException e, Object model, com.bumptech.glide.request.target.Target<Drawable> target, boolean isFirstResource) {
                                return false;
                            }
